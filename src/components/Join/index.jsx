...
const userPhotosData = [
  { id: 'upl01', src: upl01, alt: 'User', width: 60, height: 60, desktopPos: { top: '-15%', left: '26%' }, mobilePos: { top: '-7%', left: '85%' }, speedY: -35, speedXMobile: -30, panel: 'left' },
  { id: 'upl02', src: upl02, alt: 'User', width: 48, height: 48, desktopPos: { top: '5%', left: '2%' }, mobilePos: { top: '-5%', left: '5%' }, speedY: 40, speedXMobile: 35, panel: 'left' },
  { id: 'upl03', src: upl03, alt: 'User', width: 64, height: 64, desktopPos: { top: '20%', left: '13%' }, mobilePos: { top: '-6%', left: '45%' }, speedY: -30, speedXMobile: -25, panel: 'left' },
  { id: 'upl04', src: upl04, alt: 'User', width: 96, height: 96, desktopPos: { top: '50%', left: '-4%' }, mobilePos: { top: '10%', left: '-10%' }, speedY: 32, speedXMobile: 28, panel: 'left' },
  { id: 'upl05', src: upl05, alt: 'User', width: 48, height: 48, desktopPos: { top: '50%', left: '22%' }, mobilePos: { top: '7%', left: '70%' }, speedY: -42, speedXMobile: -32, panel: 'left' },
  { id: 'upl06', src: upl06, alt: 'User', width: 120, height: 120, desktopPos: { top: '60%', left: '12%' }, mobilePos: { top: '10%', left: '20%' }, speedY: 45, speedXMobile: 40, panel: 'left' },
  { id: 'upl07', src: upl07, alt: 'User', width: 32, height: 32, desktopPos: { top: '130%', left: '28%' }, mobilePos: { top: '20%', left: '90%' }, speedY: -38, speedXMobile: -20, panel: 'left' },
  { id: 'upl08', src: upl08, alt: 'User', width: 48, height: 48, desktopPos: { top: '130%', left: '0%' }, mobilePos: { top: '3%', left: '15%' }, speedY: 30, speedXMobile: 22, panel: 'left' },
  { id: 'upd01', src: upd01, alt: 'User', width: 56, height: 56, desktopPos: { top: '-20%', right: '25%' }, mobilePos: { bottom: '20%', left: '-3%' }, speedY: 35, speedXMobile: 30, panel: 'right' },
  { id: 'upd02', src: upd02, alt: 'User', width: 96, height: 96, desktopPos: { top: '-30%', right: '2%' }, mobilePos: { bottom: '15%', left: '70%' }, speedY: -40, speedXMobile: -35, panel: 'right' },
  { id: 'upd03', src: upd03, alt: 'User', width: 64, height: 64, desktopPos: { top: '29%', right: '14%' }, mobilePos: { bottom: '5%', left: '35%' }, speedY: 30, speedXMobile: 25, panel: 'right' },
  { id: 'upd04', src: upd04, alt: 'User', width: 128, height: 128, desktopPos: { top: '50%', right: '-4%' }, mobilePos: { bottom: '-3%', left: '78%' }, speedY: -32, speedXMobile: -28, panel: 'right' },
  { id: 'upd05', src: upd05, alt: 'User', width: 48, height: 48, desktopPos: { top: '95%', right: '27%' }, mobilePos: { bottom: '-8%', left: '5%' }, speedY: 38, speedXMobile: 32, panel: 'right' },
  { id: 'upd06', src: upd06, alt: 'User', width: 40, height: 40, desktopPos: { top: '110%', right: '5%' }, mobilePos: { bottom: '-12%', left: '60%' }, speedY: -45, speedXMobile: -40, panel: 'right' },
];

const iconData = [
  { id: 'il01', src: il01, alt: 'Icon', width: 56, height: 56, desktopPos: { top: '-30%', left: '0%' }, mobilePos: { top: '-10%', left: '-7%' }, panel: 'left' },
  { id: 'il02', src: il02, alt: 'Icon', width: 96, height: 96, desktopPos: { top: '-20%', left: '6%' }, mobilePos: { top: '-10%', left: '18%' }, panel: 'left' },
  { id: 'il03', src: il03, alt: 'Icon', width: 40, height: 40, desktopPos: { top: '3%', left: '20%' }, mobilePos: { top: '-9%', left: '65%' }, panel: 'left' },
  { id: 'il04', src: il04, alt: 'Icon', width: 32, height: 32, desktopPos: { top: '55%', left: '8%' }, mobilePos: { top: '3%', left: '0%' }, panel: 'left' },
  { id: 'il05', src: il05, alt: 'Icon', width: 48, height: 48, desktopPos: { top: '90%', left: '2%' }, mobilePos: { top: '20%', left: '67%' }, panel: 'left' },
  { id: 'il06', src: il06, alt: 'Icon', width: 60, height: 60, desktopPos: { top: '105%', left: '25%' }, mobilePos: { top: '10%', left: '90%' }, panel: 'left' },
  { id: 'id01', src: id01, alt: 'Icon', width: 104, height: 104, desktopPos: { top: '-8%', right: '15%' }, mobilePos: { bottom: '12%', right: '40%' }, panel: 'right' },
  { id: 'id02', src: id02, alt: 'Icon', width: 64, height: 64, desktopPos: { top: '25%', right: '22%' }, mobilePos: { bottom: '8%', right: '63%' }, panel: 'right' },
  { id: 'id03', src: id03, alt: 'Icon', width: 48, height: 48, desktopPos: { top: '20%', right: '5%' }, mobilePos: { bottom: '9%', right: '30%' }, panel: 'right' },
  { id: 'id04', src: id04, alt: 'Icon', width: 48, height: 48, desktopPos: { top: '65%', right: '13%' }, mobilePos: { bottom: '-4%', right: '35%' }, panel: 'right' },
  { id: 'id05', src: id05, alt: 'Icon', width: 32, height: 32, desktopPos: { top: '99%', right: '17%' }, mobilePos: { bottom: '-5%', right: '65%' }, panel: 'right' },
];
